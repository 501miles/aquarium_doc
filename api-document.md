...
&emsp;stretch_list.steel_type | int | N | 拉筋方式枚举: 0->一体拉筋、1->双层拉筋 |
...
| &emsp;stretch_list.steel_type | int | 拉筋方式枚举: 0->一体拉筋、1->双层拉筋 |
...
| &emsp;&emsp;item_info.stretch_list.steel_type | int | 拉筋方式枚举: 0->一体拉筋、1->双层拉筋 |
